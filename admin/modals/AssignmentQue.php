      ...
      <div class="modal-body">
        <div class="col-md-12">
          <div class="form-group">
            <label>Title</label>
            <input type="hidden" name="assi_id" value="<?php echo $_GET["id"]; ?>">
...
<div class="modal fade" id="modalForAddQuestion" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
     <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add Question - <?php echo $selAssiRow['assi_name']; ?></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
          ...
          <div class="modal-body">
            <div class="col-md-14">
              <div class="form-group">
                ...
                <input type="hidden" name="assi_id" value="<?php echo $assi_id; ?>">
...
$(document).on("submit","#AddQuestionHeader" , function(event){
  ...
  $.ajax({
		url: 'libs/AssignmentQuestion/AddQuestionHeader.php',
		dataType : "json",  
		type: 'POST',
		data: formData,
		processData: false,
...
function GetHeaderInfo(id){
  $.ajax({
    type : "post",
    url : "libs/AssignmentQuestion/GetHeaderQueInfo.php",
    dataType : "json",  
    data : {id:id},
    cache : false,
    success : function(data){
...
$(document).on("submit","#UpdateQuestionHeader" , function(event){
  ...
  var formData = new FormData(this);
  $.ajax({
		url: 'libs/AssignmentQuestion/UpdateQuestionHeader.php',
		dataType : "json",  
		type: 'POST',
		data: formData,
		processData: false,
...
$(document).on("click", "#DeletePhotoHeader", function(e){
  ...
  Swal.fire({
      ...
      if (result.value) {
        $.ajax({
        type : "post",
        url : "libs/AssignmentQuestion/DeleteQuestionHeader.php?id=1",
        dataType : "json",  
        data : {id:id},
        cache : false,
        success : function(data){
...
$(document).on("click", "#DeleteQuestionHeader", function(e){
  ...
  Swal.fire({
      ...
      if (result.value) {
        $.ajax({
        url: 'libs/AssignmentQuestion/DeleteQuestionHeader.php',
        dataType : "json",  
        type: 'POST',
        data : {id:id},
        cache : false,
...
$(document).on("submit","#addQuestionFrm" , function(){
  $.post("libs/AssignmentQuestion/addquestionExam.php", $(this).serialize() , function(data){
...
function GetQuestionInfo(id){
  $.ajax({
    type : "post",
    url : "libs/AssignmentQuestion/GetQuestionInfo.php",
    dataType : "json",  
    data : {id:id},
    cache : false,
    success : function(data){
...
$(document).on("submit","#UpdateQuestionFrm" , function(){
  $.post("libs/AssignmentQuestion/UpdateQuestion.php", $(this).serialize() , function(data){
    if(data.status == "exist")
  	{
      NotificationError("This question is already exist", "Error");
      }
...
$(document).on("click", "#deleteQuestion", function(e){
  ...
  Swal.fire({
      ...
      if (result.value) {
        $.ajax({
        type : "post",
        url : "libs/AssignmentQuestion/deletequestionExam.php",
        dataType : "json",  
        data : {id:id},
        cache : false,
        success : function(data){
